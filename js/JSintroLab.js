...
function myFunctionTest(expected, found) {
  ...
  */
  ...
  const reverse = text => {
    ...
    /* Q6: Write a function findLongestWord() that takes an array of words and 
          returns the length of the longest one.
        -> function findLongestWord accepts array of strings and returns length of the longest.
        */
    ...
    /* Q7: Write a function filterLongWords() that takes an array of words and 
          an integer i and returns the array of words that are longer than i.
        -> function filterLongWords takes array and key as its args and returns filtered array
        */
    ...
    /* Q8. Modify the jsfiddle on the map/filter/reduce slide as follows:
        https://jsfiddle.net/keithlevi/e6kqvx2f/9/
        
        a) multiply each element by 10
          -> function multiplyBy10 takes array and key as its args and returns array with elements multiplied by key
       */
    ...
    /* Q8. b) return array with all elements equal to 3
          -> function elementsEqualTo takes array and key as its args and returns array of elements equal to key 
    */
    ...
    /* Q8. c) return the product of all elements
        -> function productOfAllElements takes an array as its arg and returns product of all its elements.
      */
    ...
    /* 
      The following statements are test statements for each of the functions above.
    */
